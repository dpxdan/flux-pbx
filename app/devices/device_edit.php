	...
	if (permission_exists("device_line_password") && !empty($device_template) && $qr_code_enabled) {
		...
		if (!empty($row)) {
			...
			//build content for sipnetic
				...
				if (is_file('/usr/share/fluxpbx/templates/provision/'.$device_template.'/template.csv')) {
					$template = file_get_contents('/usr/share/fluxpbx/templates/provision/'.$device_template.'/template.csv');
				}
				else if (is_file('/var/www/fluxpbx/resources/templates/provision/'.$device_template.'/template.csv')) {
					$template = file_get_contents('/var/www/fluxpbx/resources/templates/provision/'.$device_template.'/template.csv');
				}
				if (!empty($template)) {
