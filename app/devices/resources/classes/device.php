			...
			//set the default template directory
				if (PHP_OS == "Linux") {
					//set the default template dir
						if (empty($this->template_dir)) {
							if (file_exists('/usr/share/fluxpbx/templates/provision')) {
								$this->template_dir = '/usr/share/fluxpbx/templates/provision';
							}
							elseif (file_exists('/etc/fluxpbx/resources/templates/provision')) {
								$this->template_dir = '/etc/fluxpbx/resources/templates/provision';
							}
							else {
				...
				elseif (PHP_OS == "FreeBSD") {
					//if the FreeBSD port is installed use the following paths by default.
						if (empty($this->template_dir)) {
							if (file_exists('/usr/local/share/fluxpbx/templates/provision')) {
								$this->template_dir = '/usr/local/share/fluxpbx/templates/provision';
							}
							elseif (file_exists('/usr/local/etc/fluxpbx/resources/templates/provision')) {
								$this->template_dir = '/usr/local/etc/fluxpbx/resources/templates/provision';
							}
							else {
								$this->template_dir = $_SERVER["DOCUMENT_ROOT"].PROJECT_PATH.'/resources/templates/provision';
							}
