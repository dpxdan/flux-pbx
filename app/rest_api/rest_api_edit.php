...
//get http post variables and set them to php variables
	if (is_array($_POST)) {
		...
		$api_redirect = $_POST["api_redirect"];
...
//process the user data and save it to the database
	if (count($_POST) > 0 && strlen($_POST["persistformvar"]) == 0) {
		...
		//prepare the array
			...
			$array['restapi'][0]['api_redirect'] = $api_redirect;
...
//show the content
	...
	echo "</td>\n";
	echo "<td width='70%' class='vtable' style='position: relative;' align='left'>\n";
	echo "	<input class='formfld' type='text' name='api_redirect' maxlength='255' size='70' value='".escape($api_redirect)."'>\n";
	echo "<br />\n";
