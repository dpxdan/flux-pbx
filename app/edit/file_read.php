			...
			switch (PHP_OS) {
				case "Linux":
					if (file_exists('/usr/share/fluxpbx/templates/provision')) {
						$edit_directory = '/usr/share/fluxpbx/templates/provision';
					}
					elseif (file_exists('/etc/fluxpbx/resources/templates/provision')) {
						$edit_directory = '/etc/fluxpbx/resources/templates/provision';
					}
					else {
				...
				case "FreeBSD":
					...
					elseif (file_exists('/usr/local/etc/fluxpbx/resources/templates/provision')) {
						$edit_directory = '/usr/local/etc/fluxpbx/resources/templates/provision';
					}
					else {
						$edit_directory = $_SERVER["DOCUMENT_ROOT"].PROJECT_PATH."/resources/templates/provision";
					}
