...
if (!class_exists('switch_files')) {
	class switch_files {
		...
		public function copy_scripts() {
			...
			if (file_exists('/usr/share/examples/fluxpbx/scripts')) {
				$source_directory = '/usr/share/examples/fluxpbx/scripts';
			}
			elseif (file_exists('/usr/local/var/www/fluxpbx/app/switch/resources/scripts')) {
				$source_directory = '/usr/local/var/www/fluxpbx/app/switch/resources/scripts';
			}
			elseif (file_exists('/var/www/html/fluxpbx/app/switch/resources/scripts')) {
				$source_directory = '/var/www/html/fluxpbx/app/switch/resources/scripts';
			}
			else {
		...
		public function copy_languages() {
			...
			if (file_exists('/usr/share/examples/freeswitch/conf/languages')) {
				$source_directory = '/usr/share/examples/fluxpbx/conf/languages';
			}
			elseif (file_exists('/usr/local/var/www/fluxpbx/app/switch/resources/conf/languages')) {
				$source_directory = '/usr/local/var/www/fluxpbx/app/switch/resources/conf/languages';
			}
			elseif (file_exists('/var/www/html/fluxpbx/app/switch/resources/conf/languages')) {
				$source_directory = '/var/www/html/fluxpbx/app/switch/resources/conf/languages';
			}
			else {
