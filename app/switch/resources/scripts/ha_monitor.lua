...
-- Lua code can not generate 'MEMCACHE' event so we use `CUSTOM::fluxpbx::memcache`
-- and forward MEMCACHE to it for backward compatability
service:bind('MEMCACHE', emit'CUSTOM::fluxpbx::memcache')

-- Memcache event
service:bind('CUSTOM::fluxpbx::memcache', function(self, name, event)
