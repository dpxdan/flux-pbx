...
var WebPhone = /** @class */ (function () {
    ...
    function WebPhone(regData, options) {
        ...
        var configuration = {
            ...
            autostop: false,
            register: true,
            hackIpInContact: typeof options.hackIpInContact === 'undefined' ? true : options.hackIpInContact,
            hackWssInTransport: typeof options.hackWssInTransport === 'undefined' ? true : options.hackWssInTransport,
            hackViaTcp: typeof options.hackWssInTransport === 'undefined' ? true : options.hackWssInTransport,
            displayName: this.sipInfo.username,
...
exports.patchUserAgent = function (userAgent, sipInfo, options, id) {
    userAgent.defaultHeaders = ['P-ing-endpoint-id: ' + id, 'Client-id:' + options.appKey];
    userAgent.media = {};
    ...
    userAgent.createIngMessage = createIngMessage;
...
/*--------------------------------------------------------------------------------------------------------------------*/
function createIngMessage(options) {
...
function sendMessage(to, messageData) {
    var userAgent = this;
    var sipOptions = {};
    sipOptions.contentType = 'x-ing/agent';
    sipOptions.extraHeaders = [];
    sipOptions.extraHeaders.push('P-ing-ws: ' + this.contact);
    return new Promise(function (resolve, reject) {
...
function invite(number, options) {
    ...
    if (options.homeCountryId) {
        options.extraHeaders.push('P-ing-country-id: ' + options.homeCountryId);
    }
...
function switchFrom(activeCall, options) {
    ...
    replaceHeaders.push('ING-call-type: replace');
...
/*--------------------------------------------------------------------------------------------------------------------*/
var parseIngHeaderString = function (str) {
    if (str === void 0) { str = ''; }
    var obj = {};
    var pairs = str.split(/; */);
...
var parseIngHeader = function (session) {
    var ping = session.request.headers['P-Ing'];
    var pingCallInfo = session.request.headers['P-Ing-Api-Call-Info'];
    if (ping && ping.length) {
        ...
        if (bdyNode) {
            utils_1.extend(session.ingHeaders, {
    ...
    if (pingCallInfo && pingCallInfo.length) {
        ...
        if (rawCallInfo) {
            var parsed = parseIngHeaderString(rawCallInfo);
            utils_1.extend(session.ingHeaders, parsed);
        }
    }
};
var mediaCheckTimer = 3000;
/*--------------------------------------------------------------------------------------------------------------------*/
function canUseINGMCallControl() {
    return !!this.ingHeaders;
}
/*--------------------------------------------------------------------------------------------------------------------*/
function createSessionMessage(options) {
    ...
    utils_1.extend(options, {
        sid: this.ingHeaders.sid,
        request: this.ingHeaders.request,
        from: this.ingHeaders.to,
        to: this.ingHeaders.from
    });
    return this.ua.createIngMessage(options);
}
/*--------------------------------------------------------------------------------------------------------------------*/
function ignore() {
    return __awaiter(this, void 0, void 0, function () {
...
function sendSessionMessage(options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, this.ua.sendMessage(this.ingHeaders.from, this.createSessionMessage(options))];
        });
    });
}
/*--------------------------------------------------------------------------------------------------------------------*/
                        ...
                        receiveResponse: function (response) {
                            ...
                            if (response.statusCode === 200) {
                                ...
                                var onInfo_1 = function (request) {
                                    ...
                                    session.removeListener('ING_SIP_INFO', onInfo_1);
                                ...
                                session.on('ING_SIP_INFO', onInfo_1);
                            }
                            else {
...
function receiveRequest(request) {
    ...
    switch (request.method) {
        case sip_js_1.C.INFO:
            ...
            this.emit('ING_SIP_INFO', request);
...
var publishQosStats = function (session, qosStatsObj, options) {
    ...
    var targetUrl = options.targetUrl || 'flux@177.20.204.9:5090';
...
module.exports = {"name":"flux-web-phone","version":"1.0.0","description":"Flux WebRTC","main":"./lib/index.js","types":"./lib/index.d.ts","scripts":{"test":"echo \"Error: no test specified\" && exit 1","build":"npm run build:tsc && npm run build:webpack","build-dev":"npm run build:tsc && npm run build:webpack:dev","build:tsc":"tsc","build:webpack":"cross-env NODE_ENV=production webpack --config webpack.config.js --progress --color","build:webpack:dev":"cross-env NODE_ENV=development webpack --config webpack.config.js --progress --color"},"repository":{"type":"git","url":"git+https://github.com/Flux-Cloud/flux-web-phone.git"},"publishConfig":{"@dpxdan:registry":"https://npm.pkg.github.com"},"dependencies":{"awesome-typescript-loader":"^5.2.1","getstats":"1.2.0","sip.js":"0.13.5","source-map-loader":"^1.0.0"},"devDependencies":{"@popperjs/core":"^2.9.2","@types/expect-puppeteer":"3.3.1","@types/jest":"24.0.15","@types/jest-environment-puppeteer":"4.0.0","@types/node":"12.0.8","bootstrap":"4.1.3","cache-loader":"4.0.0","copy-webpack-plugin":"5.0.3","coveralls":"3.0.4","cross-env":"5.2.0","css-loader":"^5.2.6","csv-loader":"^3.0.3","dotenv":"8.0.0","eslint":"6.8.0","eslint-config-ringcentral-typescript":"3.0.0","expose-loader":"^3.0.0","express":"^4.15.3","file-loader":"^0.11.2","html-webpack-plugin":"3.2.0","http-server":"^0.12.3","husky":"2.4.1","istanbul-instrumenter-loader":"3.0.1","flux":"npm:sip.js@^0.20.0","jest":"24.8.0","jest-puppeteer":"4.2.0","jquery":"^3.6.0","jquery-ui":"^1.12.1","lint-staged":"^11.0.0","moment":"^2.29.1","npm-run-all":"4.1.5","popper":"^1.0.1","popper.js":"^1.14.3","puppeteer":"1.18.0","ringcentral":"3.2.2","select2":"^4.1.0-rc.0","serialize-javascript":"^6.0.0","sidebar":"^1.0.2","style-loader":"^0.18.2","ts-jest":"24.0.2","ts-loader":"6.0.3","typescript":"3.9.2","uglifyjs-webpack-plugin":"2.1.3","webpack":"4.35.0","webpack-cli":"3.3.4","webpack-dev-server":"^3.11.2","webpack-merge":"^4.2.2","xml-loader":"^1.2.1"},"author":"Daniel Paixao","license":"MIT","bugs":{"url":"https://github.com/Flux-Cloud/flux-web-phone/issues"},"homepage":"https://github.com/Flux-Cloud/flux-web-phone#readme"};

/***/ })
/******/ ])["default"];
});
//# sourceMappingURL=flux-web-phone.min.js.map