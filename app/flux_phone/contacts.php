...
//    echo "	<link href=\"vendor/bootstrap/dist/css/bootstrap.min.css\" rel=\"stylesheet\"> \n";
  //  echo "	<link href=\"css/high2.css\" rel=\"stylesheet\"> \n";
  echo "    <link href=\"/resources/fontawesome6/css/all.min.css\" rel=\"stylesheet\"> \n";
  //echo "    <link href=\"scripts/flux/fonts/font-awesome-4.7.0/css/font-awesome.min.css\" rel=\"stylesheet\"> \n";
  echo "    <link href=\"https://fonts.googleapis.com/icon?family=Material+Icons+Round\" rel=\"stylesheet\">\n";
  echo "    <link href=\"scripts/flux/vendor/nucleo/css/nucleo.css\" rel=\"stylesheet\"> \n";
  //echo "    <link href=\"scripts/flux/vendor/animate/animate.css\" rel=\"stylesheet\"> \n";
  //echo "    <link href=\"scripts/flux/vendor/webphone/css/style2.css\" rel=\"stylesheet\"> \n";
  //echo "    <link href=\"scripts/flux/vendor/css-hamburgers/hamburgers.min.css\" rel=\"stylesheet\"> \n";
  //echo "    <link href=\"scripts/flux/vendor/select2/select2.min.css\" rel=\"stylesheet\"> \n";
  //echo "    <link href=\"scripts/flux/css/sidebar.css\" rel=\"stylesheet\"> \n";
  echo "    <link href=\"css/fluxSip.css\" rel=\"stylesheet\"> \n";
  echo "    <link href=\"assets/css/nucleo-icons.css\" rel=\"stylesheet\"/>\n";
  echo "    <link href=\"assets/css/nucleo-svg.css\" rel=\"stylesheet\"/>\n";
  echo "    <link href=\"assets/css/material-kit.css\" rel=\"stylesheet\"/>\n";
  echo "    <link href=\"assets/css/dashboard.css?v=1.0.0\" rel=\"stylesheet\"/>\n";
//  echo "    <link href=\"scripts/flux/css/style.css\" rel=\"stylesheet\"/>\n";
    //includes and title
    echo "    <title>WebPhone Contacts</title> \n";
    echo "</head> \n";
    echo "\n";
    echo "<body\"> \n";
...
echo "<div class='input-group'>\n";
	echo 		"<input type='text' class='form-control txt list-search' name='search' id='search' value=\"".escape($search)."\" placeholder=\"".$text['label-search']."\" onkeydown='list_search_reset();'>";
//	echo button::create(['label'=>"Search",'icon'=>$_SESSION['theme']['button_icon_search'],'type'=>'submit','id'=>'btn_search','style'=>($search != '' ? 'display: none;' : null)]);
	...
	echo "<tr class='list-header' style=\"font-size: 14px;\">\n";
	echo "<thead class='table-light'>\n";
//	echo th_order_by('contact_organization', $text['label-company'], $order_by, $order);
	echo th_order_by('contact_organization', $text['label-company'], $order_by, $order, null, null, ($search != '' ? "search=".$search : null));
	
	
//	echo th_order_by('contact_name_given', $text['label-name'], $order_by, $order);
	echo th_order_by('contact_name_given', $text['label-name'], $order_by, $order, null, null, ($search != '' ? "search=".$search : null));
	echo "	<th class='no-wrap'>".$text['label-numbers']."</th>\n";
//	echo th_order_by('contact_name_family', "Lastname", $order_by, $order);
	echo th_order_by('phone', $text['numbers'], $order_by, $order);
	echo "</thead>\n";
	echo "</tr>\n";
	...
	if (is_array($contacts) && @sizeof($contacts) != 0) {
		...
		foreach($contacts as $row) {
			...
			echo "	<td><a href='".$list_row_url."'>".escape($row['contact_organization'])."</a></td>\n";
			echo "	<td><a href='".$list_row_url."'>".escape($row['contact_name_given'])." ".escape($row['contact_name_family'])."</a></td>\n";
