...
$_SESSION['flux']['phone_open'] = "true";
//require_once "resources/bootstrap/css/bootstrap.min.css.php";
//require_once "themes/default/css.php";
//show the content
echo "<head> \n";
...
echo "<link rel='stylesheet' type='text/css' href='/resources/font-awesome-4.7.0/css/font-awesome.css'>\n";
...
<ul class="nav nav-pills nav-justified mb-3" id="ex-with-icons" role="tablist">
  <li class="nav-item" role="presentation">
    <a class="nav-link active" id="ex-with-icons-tab-1" data-mdb-toggle="pill" href="#ex-with-icons-tabs-1" role="tab"
      aria-controls="ex-with-icons-tabs-1" aria-selected="true"><i class="fa fa-phone fa-fw me-2"></i><?php echo $text['label-extension'];?></a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link" id="ex-with-icons-tab-2" data-mdb-toggle="pill" href="#ex-with-icons-tabs-2" role="tab"
      aria-controls="ex-with-icons-tabs-2" aria-selected="false"><i class="fa fa-history fa-fw me-2"></i><?php echo $text['label-history_log'];?></a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link" id="ex-with-icons-tab-3" data-mdb-toggle="pill" href="#ex-with-icons-tabs-3" role="tab"
      aria-controls="ex-with-icons-tabs-3" aria-selected="false"><i class="fa fa-address-book fa-fw me-2"></i><?php echo $text['label-contacts'];?></a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link" id="ex-with-icons-tab-4" data-mdb-toggle="pill" href="#ex-with-icons-tabs-4" role="tab"
      aria-controls="ex-with-icons-tabs-4" aria-selected="false"><i class="fa fa-gear fa-fw me-2"></i><?php echo $text['label-settings'];?></a>
  </li>
</ul>
<!-- Tabs content -->
       ...
       echo "</table>";
       				   ...
       				   email_address*/
       					    ...
       					    echo "<div class='container table-responsive'>\n";
       				    					echo "<table id='example2' class='table align-middle mb-0 table-hover table-borderless display responsive' style='width:100%'>\n";
       				    					echo "<thead class='text-primary'>";       				    		
       				    					echo "<tr>\n";
  ...
  <ul class="list-group list-group-light">
    <li class="list-group-item d-flex justify-content-between align-items-center">
      <div class="d-flex align-items-center">
       <i class="fa fa-volume-control-phone fa-fw me-2" title="Volume"></i>
        <div class="ms-3">
          <div class="range">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center">
      <div class="d-flex align-items-center">
        <i class="fa fa-microphone fa-fw me-2" title="Devices"></i>
        <div class="ms-3">
         <div id="listmic"></div>
        </div>
      </div>
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center">
      <div class="d-flex align-items-center">
        <i class="fa fa-headphones fa-fw me-2" title="Status"></i>
        <div class="ms-3">
...
//     echo "	<input type='hidden' id='user_status' name='user_status' value=\"" . escape($_REQUEST['select_user_status']) . "\">\n";
     ...
     echo "		<select id='select_user_status' name='select_user_status'>\n";
     ...
     echo "		</select>\n";
     echo "<button class='btn btn-sm btn-secondary agentSubmit' type='submit'>".$text['button-save']."</button>\n";
     echo "		</form>\n";
                                             }
                                             ?>
        </div>
...
<div class="modal fade sizefull" id="mdlTransfer" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
   <div class="modal-dialog modal-md">
     ...
     <div class="modal-header">
       ...
       <button id="transferCancel" class="btn btn-sm btn-danger transferCancel" data-mdb-dismiss="modal" style="display: none;" type="button"><?php echo $text['label-cancel'];?></button>
...
<script type="text/html" id="template-agent">
 <div class="modal fade sizefull" id="mdlAgent" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title" id="mdlAgent">Status</h6>
        <button type="button" class="btn-close" data-mdb-dismiss="modal" aria-label="Close">
        </button>
      </div>
        <div class="modal-body">
