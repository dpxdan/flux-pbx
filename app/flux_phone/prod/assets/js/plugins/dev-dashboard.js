...
function saveServerData() {
		...
		localStorage.setItem('serverData', 'true');
         console.log("proxy value is: " + proxy);
...
function saveUserData() {
      ...
      if (localStorage.getItem('serverData')) {
      var ramal = document.getElementById('login').value;
      var pass = document.getElementById('password').value;
      var nome = document.getElementById('name').value;
      var domain = document.getElementById('domain').value;
      var username = document.getElementById('login').value;
      var login = document.getElementById('login').value;
      var fromNumber = document.getElementById('login').value;
      var proxy = document.getElementById('proxy').value;
      var wssport = document.getElementById('port').value;
      var wsserver = document.getElementById('proxy').value;
      var remember = document.getElementById('rememberMe').value;
      
      
      
      //var wsserver = proxy + ':'+wssport+'';
      ...
      var user = {
      				...
      				'Remember'   : remember,
      				'Domain'  : domain,
      				'stunServers' : [{urls:'turn:45.166.193.41:5349', username : 'fluxDev' , credential: 'fluxDevTurn2010'}],
      				'Display' : ramal,
      				'WSServer'  : 'wss://'+wsserver+':'+wssport,
      				'Loglevel' : 1
      };
      var sip = {
      				'username' : ramal,
      	...
      	//   'stunServers' : [{urls: 'stun.l.google.com:19302'}],
...
var total = document.querySelectorAll('.nav-pill');
