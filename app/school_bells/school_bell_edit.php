...
//get http post variables and set them to php variables
	if (count($_POST) > 0) {
		...
		$school_bell_description = $_POST["school_bell_description"];
			...
			// Filter values:
		if (strlen($school_bell_leg_a_type) == "extension") {
			$school_bell_leg_a_type = "loopback/";
		}

		if (strlen($school_bell_leg_a_type) == "external") {
			$school_bell_leg_a_type = "sofia/external/";
		}
...
//show the content
	...
	echo "	".$text['label-school_bell_leg_a_type']."\n";
	echo "</td>\n";
	echo "<td class='vtable' style='position: relative;' align='left'>\n";
	echo "	<select class='formfld' name='school_bell_leg_a_type'>\n";
	if ($school_bell_leg_a_type == "extension") {
		echo "		<option value='loopback/' selected='selected'>".$text['label-extension']."</option>\n";
	}
	else {
		echo "		<option value='loopback/'>".$text['label-extension']."</option>\n";
	}
	if ($school_bell_leg_a_type == "external") {
		echo "		<option value='sofia/external/' selected='selected'>".$text['label-external']."</option>\n";
	}
	else {
		echo "		<option value='sofia/external/'>".$text['label-external']."</option>\n";
	}
	echo "	</select>\n";
	echo "<br />\n";
