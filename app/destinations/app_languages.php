...
$text['billing-warning']['en-us'] = "If you are using fluxpbx billing application, make sure to add accountcode and carrier variables.";
$text['billing-warning']['en-gb'] = "If you are using fluxpbx billing application, make sure to add accountcode and carrier variables.";
$text['billing-warning']['ar-eg'] = "إذا كنت تستخدم تطبيق فواتير الدمج، تأكد من إضافة رمز الحساب والمتغيرات الناقلة.";
$text['billing-warning']['de-at'] = "Wenn Sie die FluxPBX Abrechnung verwenden, stellen Sie sicher, dass Account-Code und Betreiber-Variablen gesetzt sind.";
$text['billing-warning']['de-ch'] = "Wenn Sie die FluxPBX Abrechnung verwenden, stellen Sie sicher, dass Account-Code und Betreiber-Variablen gesetzt sind.";
$text['billing-warning']['de-de'] = "Wenn Sie die FluxPBX Abrechnung verwenden, stellen Sie sicher, dass Account-Code und Betreiber-Variablen gesetzt sind.";
$text['billing-warning']['el-gr'] = "Εάν χρησιμοποιείτε την εφαρμογή χρέωσης fluxpbx, φροντίστε να προσθέσετε μεταβλητές κωδικού λογαριασμού και εταιρείας κινητής τηλεφωνίας.";
$text['billing-warning']['es-cl'] = "Si está utilizando la aplicación de facturación fluxpbx, asegúrese de agregar lasvariables accountcode y carrier";
$text['billing-warning']['es-mx'] = "Si está utilizando la aplicación de facturación fluxpbx, asegúrese de agregar lasvariables accountcode y carrier";
$text['billing-warning']['fr-ca'] = "Si vous utilisez l'application de facturation fluxpbx, assurez-vous d'ajouter des variables de accountcode et carrier";
$text['billing-warning']['fr-fr'] = "Si vous utilisez l'application de facturation fluxpbx, assurez-vous d'ajouter des variables de accountcode et carrier";
$text['billing-warning']['he-il'] = "אם אתה משתמש fluxpbx חיוב יישום, הקפד להוסיף קוד חשבון ומשתנה נושא.";
$text['billing-warning']['it-it'] = "Se si usa l'applicazione per la fatturazione di fluxpbx, accertarsi di valorizzare accountcode e carrier.";
$text['billing-warning']['nl-nl'] = "Als je fluxpbx doorbelastingen applicatie gebruikt, zorg dan dat account code en Telco variabelen in gevuld zijn.";
$text['billing-warning']['pl-pl'] = "Jeżeli używasz platformę billingowa z FluxPBX, dodaj numer konta billingowego oraz zmienne operatora";
...
$text['billing-warning']['pt-pt'] = "Se você estiver usando o aplicativo de faturamento fluxpbx, certifique-se de adicionar variáveis accountcode e carrier";
$text['billing-warning']['ro-ro'] = "Dacă utilizați aplicația de facturare fluxpbx, asigurați-vă că adăugați codul de cont și variabilele operatorului.";
$text['billing-warning']['ru-ru'] = "Если вы используете приложение биллинга FluxPBX, обязательно добавьте код учетной записи и переменные-несущие.";
$text['billing-warning']['sv-se'] = "Om du använder fluxpbx fakturering program, se till att lägga till 'account code' och operatör variabler";
$text['billing-warning']['uk-ua'] = "Якщо ви користуєтеся додатком для тарифікації в fluxpbx, то переконайтеся, щоб додано змінні код облікового запису і оператора. ";
$text['billing-warning']['tr-tr'] = "FluxPBX faturalandırma uygulamasını kullanıyorsanız hesap kodunu ve operatör değişkenlerini eklediğinizden emin olun.";
$text['billing-warning']['zh-cn'] = "如果您使用的是 fluxpbx 计费应用程序，请确保添加帐户代码和运营商变量。";
$text['billing-warning']['ja-jp'] = "fluxpbx 請求アプリケーションを使用している場合は、必ずアカウントコードとキャリア変数を追加してください。";
$text['billing-warning']['ko-kr'] = "fluxpbx 결제 애플리케이션을 사용하는 경우 계정 코드 및 이동통신사 변수를 추가해야 합니다.";
