...
$array['dashboard'][$x]['dashboard_name'] = 'Flux Providers Forward';
$array['dashboard'][$x]['dashboard_path'] = 'app/flux_providers/resources/dashboard/flux_provider_forward.php';
$array['dashboard'][$x]['dashboard_order'] = '180';
$array['dashboard'][$x]['dashboard_enabled'] = 'true';
$array['dashboard'][$x]['dashboard_description'] = 'Used for updating flux providers call forward.';
$y = 0;
