...
//build an array from dot notation
	//$setting['data.attributes.from'] = 'daniel@fluxpbx.com';
	//$setting['data.attributes.to'] = 'lucas@fluxpbx.com';
...
//how to use it
	// php /var/www/html/fluxpbx/app/messages/resources/service/message_send_outbound.php message_queue_uuid=39402652-1475-49f8-8366-7889335edd6f&hostname=dev2.flux.net.br
