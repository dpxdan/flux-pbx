...
//send the sip message
	if (is_array($extensions) && @sizeof($extensions) != 0) {
		...
		foreach ($extensions as $extension) {
			...
			//$message_to = '1005@voip.fluxpbx.com';
...
//how to use it
	// php /var/www/html/fluxpbx/app/messages/resources/service/message_send_inbound.php message_queue_uuid=39402652-1475-49f8-8366-7889335edd6f&hostname=dev2.flux.net.br
