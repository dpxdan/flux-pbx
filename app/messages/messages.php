...
//get (from) destinations
	$sql = "select destination_number,user_uuid from v_destinations ";
...
//js to load messages for clicked number
	...
	echo "	var contact_uuid = '".$_SESSION['user_uuid']."';\n";
	...
	echo "		$('#thread').load('messages_thread.php?number=' + encodeURIComponent(number) + '&contact_uuid=' + encodeURIComponent('".$_SESSION['user_uuid']."'), function(){\n";
