...
if ($domains_processed == 1) {
	...
	//base64 decode the description - added for backwards comptability with old versions of FluxPBX
	...
	//add the variables to the database
		...
		if ($num_rows == 0) {
			//get the xml
				if (file_exists('/usr/share/examples/fluxpbx/resources/templates/conf/vars.xml')) {
					$xml_file = '/usr/share/examples/fluxpbx/resources/templates/conf/vars.xml';
				}
				elseif (file_exists('/usr/local/share/fluxpbx/resources/templates/conf/vars.xml')) {
					$xml_file = '/usr/local/share/fluxpbx/resources/templates/conf/vars.xml';
				}
				elseif (file_exists('/usr/local/var/www/fluxpbx/app/switch/resources/conf/vars.xml')) {
					$xml_file = '/usr/local/var/www/fluxpbx/app/switch/resources/conf/vars.xml';
				}
				elseif (file_exists('/var/www/html/fluxpbx/app/switch/resources/conf/vars.xml')) {
					$xml_file = '/var/www/html/fluxpbx/app/switch/resources/conf/vars.xml';
				}
				else {
