...
$text['billing-warning']['it-it'] = "Se si utilizza l'applicazione di fatturazione fluxpbx, assicurarsi di aggiungere codice account e variabili di vettore.";
$text['billing-warning']['nl-nl'] = "Als je de fluxpbx rekening toepassing gebruikt, zorg dan dat een account code en telco variabele toegevoegd is.";
