							...
							if (!isset($row['queue_name'])) {
								if ($agent_status == "Do Not Disturb") {
									...
									if (is_uuid($row['agent_uuid'])) {
										...
										$command2 = "callcenter_config agent set custom_status " . $row['agent_uuid'] . " '" . $agent_status . "'";
										$response = event_socket::api($command);
										$response2 = event_socket::api($command2);
...
if ($per_queue_login) {
	echo "	<th class='pct-10'>" . $text['label-agent'] . "</th>\n";
} else {
...
echo "	<th class='pct-10 hide-sm-dn'>&nbsp;</th>\n";
	if ($per_queue_login) {
	echo "	<th style='text-align: center;'>" . $text['label-options'] . "</th>\n";
	//echo "	<th class='pct-40'>" . $text['label-options'] . "</th>\n";
	}
//echo "	<th>" . $text['label-custom_status'] . "</th>\n";
	echo "</tr>\n";
	...
	if (!empty($agents)) {
		...
		foreach ($agents as $row) {
			...
			$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='On Meeting' " . ($row['agent_status'] == 'On Meeting' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-meeting'] . "</label>\n";
			$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Feedback' " . ($row['agent_status'] == 'Feedback' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-feedback'] . "</label>\n";
			$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Lunch' " . ($row['agent_status'] == 'Lunch' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-lunch'] . "</label>\n";
			$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Snack' " . ($row['agent_status'] == 'Snack' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-snack'] . "</label>\n";
			$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Bathroom' " . ($row['agent_status'] == 'Bathroom' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-bathroom'] . "</label>\n";
			$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Training' " . ($row['agent_status'] == 'Training' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-training'] . "</label>\n";
				...
				if (!empty($row['queues'])) {
					...
					if (!empty($row['queues'])) {
						foreach ($row['queues'] as $queue) {
							...
							$onclick = "onclick=\"cycle('agents[".$x."][agent_status]');\"";
							$html .= "	<tr class='list-row'>\n";
						$html .= "		<td " . $onclick . " class='pct-12 no-wrap'>" . $queue['queue_name'] . "</td>\n";
						...
						if ($queue['queue_status'] == "On Meeting") {
							$html .= "		" . $text['option-meeting'] . "\n";
						}
						if ($queue['queue_status'] == "On Break") {
							$html .= "		" . $text['option-on_break'] . "\n";
						}
						if ($queue['queue_status'] == "Feedback") {
							$html .= "		" . $text['option-feedback'] . "\n";
						}
						if ($queue['queue_status'] == "Lunch") {
							$html .= "		" . $text['option-lunch'] . "\n";
						}
						if ($queue['queue_status'] == "Snack") {
							$html .= "		" . $text['option-snack'] . "\n";
						}
						if ($queue['queue_status'] == "Bathroom") {
							$html .= "		" . $text['option-bathroom'] . "\n";
						}
						if ($queue['queue_status'] == "Training") {
							$html .= "		" . $text['option-tranining'] . "\n";
						}
							$html .= "		</td>\n";
						$html .= "		<td class='no-wrap'>";
						...
						$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='On Meeting' " . ($queue['queue_status'] == 'On Meeting' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-meeting'] . "</label>\n";
						$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Feedback' " . ($queue['queue_status'] == 'Feedback' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-feedback'] . "</label>\n";
						$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Lunch' " . ($queue['queue_status'] == 'Lunch' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-lunch'] . "</label>\n";
						$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Snack' " . ($queue['queue_status'] == 'Snack' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-snack'] . "</label>\n";
						$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Bathroom' " . ($queue['queue_status'] == 'Bathroom' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-bathroom'] . "</label>\n";
						$html .= "		<label style='margin: 0; cursor: pointer;'><input type='radio' name='agents[" . $x . "][agent_status]' value='Training' " . ($queue['queue_status'] == 'Training' ? "checked='checked'" : null) . ">&nbsp;" . $text['option-training'] . "</label>\n";
							$html .= "		</td>\n";
							$html .= "	</tr>\n";
						}
					}
