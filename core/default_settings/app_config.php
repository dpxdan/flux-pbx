<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "name";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "America/Sao_Paulo";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "";
		$y++;
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "code";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "br";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "";
		$y++;
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "/var/cache/fluxpbx";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
