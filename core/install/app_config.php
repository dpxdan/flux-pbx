<?php
	...
	//application details
		...
		$apps[$x]['description']['de-at'] = "Installiere das FluxPBX System oder füge neue Switches hinzu.";
		$apps[$x]['description']['de-ch'] = "";
		$apps[$x]['description']['de-de'] = "Installiere das FluxPBX System oder füge neue Switches hinzu.";
