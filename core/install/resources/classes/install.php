...
if (!class_exists('install')) {
	class install {
		...
		*/
		 ...
		 * <p>BSD /usr/local/etc/fluxpbx</p>
		 * <p>Linux /etc/fluxpbx</p>
		 * @return boolean
		 */
		public function config() {
			...
			case "BSD":
				...
				$document_root = '/usr/local/var/www/fluxpbx';
				...
				$scripts_dir = '/usr/share/freeswitch/scripts7';
				$php_dir = PHP_BINDIR;
				$cache_location = '/var/cache/fluxpbx';
				break;
			case "LIN":
				$config_path = '/etc/fluxpbx/';
				$config_file = $config_path.'/config.conf';
				$document_root = '/var/www/fluxpbx';
			...
			case "WIN":
				...
				$config_path = $system_drive . DIRECTORY_SEPARATOR . 'ProgramData' . DIRECTORY_SEPARATOR . 'fluxpbx' ;
				...
				$cache_location = dirname($_SERVER['DOCUMENT_ROOT']).DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.'fluxpbx';
				break;
			}
			...
			$conf .= "database.1.name = ".$this->database_name."\n";
			$conf .= "database.1.username = ".$this->database_username."\n";
