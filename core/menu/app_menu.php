<?php
	...
	$apps[$x]['menu'][$y]['groups'][] = "fax";
	$y++;
	$apps[$x]['menu'][$y]['title']['en-us'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['en-gb'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['ar-eg'] = "";
	$apps[$x]['menu'][$y]['title']['de-at'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['de-de'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['es-cl'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['es-mx'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['fr-ca'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['fr-fr'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['he-il'] = "";
	$apps[$x]['menu'][$y]['title']['it-it'] = "";
	$apps[$x]['menu'][$y]['title']['nl-nl'] = "";
	$apps[$x]['menu'][$y]['title']['pl-pl'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['pt-br'] = "Aplicativos Flux";
	$apps[$x]['menu'][$y]['title']['pt-pt'] = "Aplicativos Flux";
	$apps[$x]['menu'][$y]['title']['ro-ro'] = "";
	$apps[$x]['menu'][$y]['title']['ru-ru'] = "Flux Интеграции";
	$apps[$x]['menu'][$y]['title']['sv-se'] = "Flux Applications";
	$apps[$x]['menu'][$y]['title']['uk-ua'] = "Flux Applications";
	$apps[$x]['menu'][$y]['uuid'] = "466e2272-bd86-405a-a0b2-b455da2d48b4";
	$apps[$x]['menu'][$y]['parent_uuid'] = "";
	$apps[$x]['menu'][$y]['category'] = "internal";
	$apps[$x]['menu'][$y]['icon'] = "fa-code";
	$apps[$x]['menu'][$y]['path'] = "";
	...
	$apps[$x]['menu'][$y]['groups'][] = "agent";
	$y++;
	$apps[$x]['menu'][$y]['title']['en-us'] = "Flux Integrations";
	$apps[$x]['menu'][$y]['title']['en-gb'] = "Flux Integrations";
	$apps[$x]['menu'][$y]['title']['ar-eg'] = "";
	$apps[$x]['menu'][$y]['title']['de-at'] = "Flux Integrationen";
	$apps[$x]['menu'][$y]['title']['de-de'] = "Flux Integrationen";
	$apps[$x]['menu'][$y]['title']['es-cl'] = "Flux Integraciones";
	$apps[$x]['menu'][$y]['title']['es-mx'] = "Flux Integraciones";
	$apps[$x]['menu'][$y]['title']['fr-ca'] = "Flux Intégrations";
	$apps[$x]['menu'][$y]['title']['fr-fr'] = "Flux Intégrations";
	$apps[$x]['menu'][$y]['title']['he-il'] = "";
	$apps[$x]['menu'][$y]['title']['it-it'] = "";
	$apps[$x]['menu'][$y]['title']['nl-nl'] = "";
	$apps[$x]['menu'][$y]['title']['pl-pl'] = "Flux Integracje";
	$apps[$x]['menu'][$y]['title']['pt-br'] = "Flux Integrações";
	$apps[$x]['menu'][$y]['title']['pt-pt'] = "Flux Integrações";
	$apps[$x]['menu'][$y]['title']['ro-ro'] = "";
	$apps[$x]['menu'][$y]['title']['ru-ru'] = "Flux Интеграции";
	$apps[$x]['menu'][$y]['title']['sv-se'] = "Flux Integrations";
	$apps[$x]['menu'][$y]['title']['uk-ua'] = "Flux Integrations";
	$apps[$x]['menu'][$y]['uuid'] = "da4d616a-1c23-4a0b-b7ef-452d424d9bc6";
	$apps[$x]['menu'][$y]['parent_uuid'] = "";
	$apps[$x]['menu'][$y]['category'] = "internal";
	$apps[$x]['menu'][$y]['icon'] = "fa-user-friends";
	$apps[$x]['menu'][$y]['path'] = "";
