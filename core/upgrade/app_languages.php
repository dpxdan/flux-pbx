...
$text['login-message_text']['en-us'] = "Keep up with the FluxPBX project by configuring your preferences in the newly added <a href=''/core/notifications/notification_edit.php''>Notifications</a> section, under the System menu!";
$text['login-message_text']['en-gb'] = "Keep up with the FluxPBX project by configuring your preferences in the newly added <a href=''/core/notifications/notification_edit.php''>Notifications</a> section, under the System menu!";
$text['login-message_text']['ar-eg'] = "حافظ على مشروع (فيوس بي إكس) من خلال تشكيل أفضلياتك في القسم المضاف حديثاً";
$text['login-message_text']['de-at'] = "Halten Sie sich über FluxPBX auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen.";
$text['login-message_text']['de-ch'] = "Halten Sie sich über FluxPBX auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen.";
$text['login-message_text']['de-de'] = "Halten Sie sich über FluxPBX auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen.";
$text['login-message_text']['el-gr'] = "Συνεχίστε με το έργο FluxPBX διαμορφώνοντας τις προτιμήσεις σας στην ενότητα <a href=''/core/notifications/notification_edit.php''>Ειδοποιήσεις</a> που προστέθηκε πρόσφατα, κάτω από το μενού Σύστημα!";
$text['login-message_text']['es-cl'] = "Manténgase al día con el proyecto FluxPBX configurando sus preferencias en la sección <a href=''/core/notifications/notification_edit.php''>Notificaciones</a> acaba de agregar, en el menú del sistema!";
$text['login-message_text']['es-mx'] = "Manténgase al día con el proyecto FluxPBX configurando sus preferencias en la sección <a href=''/core/notifications/notification_edit.php''>Notificaciones</a> acaba de agregar, en el menú del sistema!";
$text['login-message_text']['fr-ca'] = "Tenez-vous au courant des nouveautés du projet FluxPBX en configurant vos préférences dans la section <a href=''/core/notifications/notification_edit.php''>Notifications</a> , du menu système!";
$text['login-message_text']['fr-fr'] = "Tenez-vous au courant des nouveautés du projet FluxPBX en configurant vos préférences dans la section <a href=''/core/notifications/notification_edit.php''>Notifications</a> , du menu système!";
$text['login-message_text']['he-il'] = "שמור על הפרויקט FluxPBX על ידי הצבת ההעדפות שלך ב- <a href='/core/notifications/notifications_edit.php'>Notifications</a>, תחת תפריט המערכת!";
$text['login-message_text']['it-it'] = "Tieniti aggiornato sul progetto FluxPBX configurando le tue preference nella nuova sezione <a href=''/core/notifications/notification_edit.php''>Notifiche</a>, sotto il menu sistema!";
$text['login-message_text']['nl-nl'] = "Ga door met het FluxPBX project door je voorkeuren te versterken in de nieuwe toegevoegde voeg = = = = = /core /core /notificatie / niet-fificatie = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =";
$text['login-message_text']['pl-pl'] = "Bądź na bieżąco z projektem FluxPBX konfigurując swoje preferencje w  nowo dodanej sekcji Powiadomienia w menu System!";
$text['login-message_text']['pt-br'] = "Mantenha-se com o projeto FluxPBX configurando suas preferências na seção <a href=''/core/notifications/notification_edit.php''>Notificações</a> recém-adicionado, no menu Sistema!";
$text['login-message_text']['pt-pt'] = "Mantenha-se com o projeto FluxPBX configurando suas preferências na seção <a href=''/core/notifications/notification_edit.php''>Notificações</a> recém-adicionado, no menu Sistema!";
$text['login-message_text']['ro-ro'] = "Fii la curent cu proiectul FluxPBX configurându-ți preferințele în secțiunea nou adăugată <a href=''/core/notifications/notification_edit.php''>Notificări</a>, din meniul Sistem!";
$text['login-message_text']['ru-ru'] = "Следите за проектом FluxPBX, настроив свои настройки в недавно добавленном разделе <a href=''/core/notifications/notification_edit.php''>Уведомления</a> в меню 'Система'!";
$text['login-message_text']['sv-se'] = "Håll dig uppdaterad med de FluxPBX projektet genom att konfigurera dina inställningar i nytillkomna Notifications avsnitt , under Systemmenyn !";
$text['login-message_text']['uk-ua'] = "Будьте в курсі проекту FluxPBX, налаштовуючи свої налаштування в нещодавно доданому <a href='/core/notifications/notification_edit.php'> сповіщення </a> Розділ, в меню системи!";
...
$text['login-message_text']['ja-jp'] = '新しく追加された <a href=""/core/notifications/notifications_edit.php">Notifications</a> セクションで設定することで FluxPBX プロジェクトを続けてください。';
$text['login-message_text']['ko-kr'] = "시스템 메뉴에서 새로 추가 된 <a href=''/core/notifications/notification_edit.php'''php'' '> 알림 </a>에서 선호도를 구성하여 FluxPBX 프로젝트를 유지하십시오!";
...
$text['description-upgrade_source']['en-us'] = "Updates FluxPBX source files from the repository.";
$text['description-upgrade_source']['en-gb'] = "Updates FluxPBX source files from the repository.";
$text['description-upgrade_source']['ar-eg'] = "(أحدث ملفات مصادر (فيوس بي إكس من المستودع";
$text['description-upgrade_source']['de-at'] = "Aktualisiert den FluxPBX Quellcode aus dem Repository";
$text['description-upgrade_source']['de-ch'] = "Aktualisiert den FluxPBX Quellcode aus dem Repository";
$text['description-upgrade_source']['de-de'] = "Aktualisiert den FluxPBX Quellcode aus dem Repository";
$text['description-upgrade_source']['el-gr'] = "Ενημερώνει τα αρχεία πηγής FluxPBX από το αποθετήριο.";
$text['description-upgrade_source']['es-cl'] = "Archivos de origen Actualizaciones FluxPBX del repositorio.";
$text['description-upgrade_source']['es-mx'] = "Archivos de origen Actualizaciones FluxPBX del repositorio.";
$text['description-upgrade_source']['fr-ca'] = "Mise à jour du code source de FluxPBX depuis le dépôt.";
$text['description-upgrade_source']['fr-fr'] = "Mise à jour du code source de FluxPBX depuis le dépôt.";
$text['description-upgrade_source']['he-il'] = "עדכון קובצי המקור של FluxPBX מ-Respository.";
$text['description-upgrade_source']['it-it'] = "Aggiorna il files sorgente di FluxPBX dal repository.";
$text['description-upgrade_source']['nl-nl'] = "Updates FluxPBX bron bestanden van het verzet.";
$text['description-upgrade_source']['pl-pl'] = "Uaktualnia pliki źródłowe FluxPBX z przechowalni.";
$text['description-upgrade_source']['pt-br'] = "Atualiza o FluxPBX a partir dos arquivos de código fonte do repositório.";
$text['description-upgrade_source']['pt-pt'] = "Arquivos de origem Atualizações FluxPBX do repositório.";
$text['description-upgrade_source']['ro-ro'] = "Actualizează fișierele sursă FluxPBX din depozit.";
$text['description-upgrade_source']['ru-ru'] = "Обновляет исходные файлы FluxPBX из репозитория.";
$text['description-upgrade_source']['sv-se'] = "Uppdaterar FluxPBX källfiler från respository.";
$text['description-upgrade_source']['uk-ua'] = "Оновлення вихідних файлів  FluxPBX з репозиторію Subversion .";
...
$text['description-upgrade_source']['ko-kr'] = "저장소에서 FluxPBX 소스 파일을 업데이트합니다.";
