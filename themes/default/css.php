...
$header_phone_color_hover = $_SESSION['theme']['header_user_color_hover']['text'] ?? '#1892e6';
...
$menu_main_icon_color = $_SESSION['theme']['menu_main_icon_color']['text'] ?? '#ffffff';
...
$button_border_color = $_SESSION['theme']['button_border_color']['text'] ?? '#3340bd';
$button_border_radius = $_SESSION['theme']['button_border_radius']['text'] ?? null;
$button_background_color = $_SESSION['theme']['button_background_color']['text'] ?? '#2a3390';
$button_background_color_bottom = $_SESSION['theme']['button_background_color_bottom']['text'] ?? '#2a3390';
...
$button_border_color_hover = $_SESSION['theme']['button_border_color_hover']['text'] ?? '#2b3491';
$button_background_color_hover = $_SESSION['theme']['button_background_color_hover']['text'] ?? '#2b3491';
$button_background_color_bottom_hover = $_SESSION['theme']['button_background_color_bottom_hover']['text'] ?? '#2b3491';
...
$provider_selector_background_color = $_SESSION['theme']['provider_selector_background_color']['text'] ?? '#fff';
$provider_selector_shadow_color = isset($_SESSION['theme']['provider_selector_shadow_color']['text']) ? '0 0 10px '.$_SESSION['theme']['provider_selector_shadow_color']['text'] : 'none';
$provider_selector_title_color = $_SESSION['theme']['provider_selector_title_color']['text'] ?? '#000';
$provider_selector_title_color_hover = $_SESSION['theme']['provider_selector_title_color_hover']['text'] ?? '#5082ca';
$provider_selector_list_background_color = $_SESSION['theme']['provider_selector_list_background_color']['text'] ?? '#fff';
$provider_selector_list_border_color = $_SESSION['theme']['provider_selector_list_border_color']['text'] ?? '#a4aebf';
$provider_selector_list_divider_color = $_SESSION['theme']['provider_selector_list_divider_color']['text'] ?? '#c5d1e5';
$provider_active_text_color = $_SESSION['theme']['provider_active_text_color']['text'] ?? '#004083';
$provider_active_text_color_hover = $_SESSION['theme']['provider_active_text_color_hover']['text'] ?? '#004083';
$provider_inactive_text_color = $_SESSION['theme']['provider_inactive_text_color']['text'] ?? '#004083';
$provider_inactive_text_color_hover = $_SESSION['theme']['provider_inactive_text_color_hover']['text'] ?? '#004083';
$provider_active_desc_text_color = $_SESSION['theme']['provider_active_desc_text_color']['text'] ?? '#999';
$provider_inactive_desc_text_color = $_SESSION['theme']['provider_inactive_desc_text_color']['text'] ?? '#999';
...
$heading_text_color = $_SESSION['theme']['heading_text_color']['text'] ?? '#2a3390';
$heading_text_size = $_SESSION['theme']['heading_text_size']['text'] ?? '15px';
$heading_text_font = $_SESSION['theme']['heading_text_font']['text'] ?? 'arial';
...
if ($background_images_enabled) {
	...
	if (count($background_images) > 0) {
		...
		if (in_array(strtolower(pathinfo($background_image, PATHINFO_EXTENSION)), $image_extensions)) {
            ...
            $background_default_image = PROJECT_PATH.'/themes/default/images/backgrounds/background.jpg';
            $_SESSION['background_default_image'] = PROJECT_PATH.'/themes/default/images/backgrounds/background.jpg';
            }
	...
	if ($image_source == 'folder') {
		if (file_exists($_SERVER["DOCUMENT_ROOT"].$source_path)) {
			...
			if (empty($_SESSION['background_image']) && !empty($v_background_array)) {
				...
				$_SESSION['background_image'] = $background_default_image;
		}
...
?>
	...
	body {
		...
		echo "background-image: url('/themes/default/images/backgrounds/background.jpg');\n";
		echo "background-size: 100% 100%;\n";
		echo "background-position: top;\n";
		}
		?>
...
/* MENU: BEGIN ******************************************************************/
	...
	ul.navbar-nav > li.nav-item > a.header_phone,
	...
	ul.navbar-nav > li.nav-item:active > a.header_user {
		...
		ul.navbar-nav > li.nav-item:hover > a.header_phone,
		ul.navbar-nav > li.nav-item:focus > a.header_phone,
		ul.navbar-nav > li.nav-item:active > a.header_phone {
			color: <?=$header_phone_color_hover?>;
			}
...
/* PROVIDER SELECTOR ***********************************************************/
	...
	#providers_block {
		...
		font-size: 10pt;
		overflow: hidden;
		background: <?=$provider_selector_background_color?>;
		-webkit-box-shadow: <?=$provider_selector_shadow_color?>;
		-moz-box-shadow: <?=$provider_selector_shadow_color?>;
		box-shadow: <?=$provider_selector_shadow_color?>;
		}
	...
	#providers_header > a#providers_title {
		font-weight: 600;
		font-size: <?=$heading_text_size?>;
		font-family: <?=$heading_text_font?>;
		color: <?=$provider_selector_title_color?>;
		}

	#providers_header > a#providers_title:hover {
		text-decoration: none;
		color: <?=$provider_selector_title_color_hover?>;
		}
	...
	#providers_list {
		...
		height: 100%;
		padding: 1px;
		background: <?=$provider_selector_list_background_color?>;
		border: 1px solid <?=$provider_selector_list_border_color?>;
		}

	div.providers_list_item, div.providers_list_item_active, div.providers_list_item_inactive {
		text-align: left;
		border-bottom: 1px solid <?=$provider_selector_list_divider_color?>;
		padding: 5px 8px 8px 8px;
		overflow: hidden;
		white-space: nowrap;
		cursor: pointer;
	...
	div.providers_list_item span.provider_list_item_description,
	div.providers_list_item_active span.provider_list_item_description,
	div.providers_list_item_inactive span.provider_list_item_description,

	div.providers_list_item_active span.provider_active_list_item_description,
	div.providers_list_item_inactive span.provider_inactive_list_item_description {
		font-size: 11px;
		}
	...
	div.providers_list_item_active a {
		color: <?=$provider_active_text_color?>;
		}

	div.providers_list_item_inactive a {
		color: <?=$provider_inactive_text_color?>;
		}

	div.providers_list_item_active span.provider_active_list_item_description {
		color: <?=$provider_active_desc_text_color?>;
		}

	div.providers_list_item_inactive span.provider_inactive_list_item_description {
		color: <?=$provider_inactive_desc_text_color?>;
		}

	div.providers_list_item:hover a,
	div.providers_list_item:hover span {
		color: #5082ca;
		}

	div.providers_list_item_active:hover a,
	div.providers_list_item_active:hover span {
		color: <?=$provider_active_text_color_hover?>;
	}

	div.providers_list_item_inactive:hover a,
	div.providers_list_item_inactive:hover span {
		color: <?=$provider_inactive_text_color_hover?>;
	}

/* PROVIDER SELECTOR: END ********************************************************/
...
/* EXTENSION SELECTOR ***********************************************************/
	...
	#extension_block {
		...
		font-size: 10pt;
		overflow: hidden;
		background: <?php echo ($_SESSION['theme']['extension_selector_background_color']['text'] != '') ? $_SESSION['theme']['extension_selector_background_color']['text'] : '#fff'; ?>;
		-webkit-box-shadow: <?php echo ($_SESSION['theme']['extension_selector_shadow_color']['text'] != '') ? '0 0 10px '.$_SESSION['theme']['extension_selector_shadow_color']['text'] : 'none'; ?>;
		-moz-box-shadow: <?php echo ($_SESSION['theme']['extension_selector_shadow_color']['text'] != '') ? '0 0 10px '.$_SESSION['theme']['extension_selector_shadow_color']['text'] : 'none'; ?>;
		box-shadow: <?php echo ($_SESSION['theme']['extension_selector_shadow_color']['text'] != '') ? '0 0 10px '.$_SESSION['theme']['extension_selector_shadow_color']['text'] : 'none'; ?>;
		}
	...
	#extension_header > a#extension_title {
		font-weight: 600;
		...
		color: <?php echo ($_SESSION['theme']['extension_selector_title_color']['text'] != '') ? $_SESSION['theme']['extension_selector_title_color']['text'] : '#000'; ?>;
		}

	#extension_header > a#extension_title:hover {
		text-decoration: none;
		color: <?php echo ($_SESSION['theme']['extension_selector_title_color_hover']['text'] != '') ? $_SESSION['theme']['extension_selector_title_color_hover']['text'] : '#5082ca'; ?>;
		}
	...
	#extension_list {
		...
		height: 100%;
		padding: 1px;
		background: <?php echo ($_SESSION['theme']['extension_selector_list_background_color']['text'] != '') ? $_SESSION['theme']['extension_selector_list_background_color']['text'] : '#fff'; ?>;
		border: 1px solid <?php echo ($_SESSION['theme']['extension_selector_list_border_color']['text'] != '') ? $_SESSION['theme']['extension_selector_list_border_color']['text'] : '#a4aebf'; ?>;
		}

	div.extension_list_item, div.extension_list_item_active, div.extension_list_item_inactive {
		text-align: left;
		border-bottom: 1px solid <?php echo ($_SESSION['theme']['extension_selector_list_divider_color']['text'] != '') ? $_SESSION['theme']['extension_selector_list_divider_color']['text'] : '#c5d1e5'; ?>;
		padding: 5px 8px 8px 8px;
		overflow: hidden;
		white-space: nowrap;
		cursor: pointer;
	...
	div.extension_list_item span.extension_list_item_description,
	div.extension_list_item_active span.extension_list_item_description,
	div.extension_list_item_inactive span.extension_list_item_description,

	div.extension_list_item_active span.extension_active_list_item_description,
	div.extension_list_item_inactive span.extension_inactive_list_item_description {
		font-size: 11px;
		}
	...
	div.extension_list_item_active a {
		color: <?php echo ($_SESSION['theme']['extension_active_text_color']['text'] != '') ? $_SESSION['theme']['extension_active_text_color']['text'] : '#004083'; ?>;
	}
	div.extension_list_item_inactive a {
		color: <?php echo ($_SESSION['theme']['extension_inactive_text_color']['text'] != '') ? $_SESSION['theme']['extension_inactive_text_color']['text'] : '#004083'; ?>;
	}

	div.extension_list_item_active span.extension_active_list_item_description {
		color: <?php echo ($_SESSION['theme']['extension_active_desc_text_color']['text'] != '') ? $_SESSION['theme']['extension_active_desc_text_color']['text'] : '#999'; ?>;
		}

	div.extension_list_item_inactive span.extension_inactive_list_item_description {
		color: <?php echo ($_SESSION['theme']['extension_inactive_desc_text_color']['text'] != '') ? $_SESSION['theme']['extension_inactive_desc_text_color']['text'] : '#999'; ?>;
		}

	div.extension_list_item:hover a,
	div.extension_list_item:hover span {
		color: #5082ca;
		}

	div.extension_list_item_active:hover a,
	div.extension_list_item_active:hover span {
		color: <?php echo ($_SESSION['theme']['extension_active_text_color_hover']['text']); ?>;
	}

	div.extension_list_item_inactive:hover a,
	div.extension_list_item_inactive:hover span {
		color: <?php echo ($_SESSION['theme']['extension_inactive_text_color_hover']['text']); ?>;
	}

/* EXTENSION SELECTOR: END ********************************************************/
...
#sipClientMobile #sip-dialpad-mobile {
  width: 240px;
  padding: 5px 36px;
}
  ...
  cursor: pointer;
	...
	#op_btn_status_logged_out {
		...
		#op_btn_status_lunch {
			...
			#op_btn_status_feedback {
				background-image: -moz-linear-gradient(top, #d66721 0%, #d69721 100%);
				background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #d66721), color-stop(1, #d69721));
