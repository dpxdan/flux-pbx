...
class config {
	...
	public function find() {
		...
		//find the file
			if (file_exists("/etc/fluxpbx/config.conf")) {
				$this->config_path = "/etc/fluxpbx/config.conf";
			}
			elseif (file_exists("/usr/local/etc/fluxpbx/config.conf")) {
				$this->config_path = "/usr/local/etc/fluxpbx/config.conf";
			}
			...
			elseif (file_exists("/etc/fluxpbx/config.php")) {
				$this->config_path = "/etc/fluxpbx/config.php";
			}
			elseif (file_exists("/usr/local/etc/fluxpbx/config.php")) {
				$this->config_path = "/usr/local/etc/fluxpbx/config.php";
			}
			else {
				$this->config_path = '';
			}
