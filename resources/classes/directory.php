	...
	class switch_directory {
		...
		function xml_save_all() {
			...
			//define the group members
				...
				$xml .= "\n";
				$xml .= "	FluxPBX works off the concept of users and domains just like email.\n";
				$xml .= "	You have users that are in domains for example 1000@domain.com.\n";
				$xml .= "\n";
				$xml .= "	When fluxpbx gets a register packet it looks for the user in the directory\n";
				...
				$xml .= "	machine running FluxPBX.  This IP can be found by typing \"sofia status\" at the\n";
