--
-- Name: agents; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
CREATE TABLE agents (
   uuid uuid,
   ...
   provider_status uuid,
   telephony_status character varying(255),
   extension_uuid uuid,   
...
ALTER TABLE agents OWNER TO fluxuser;


--
-- Name: aliases; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE aliases OWNER TO fluxuser;

--
-- Name: calls; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
CREATE TABLE calls (
...
ALTER TABLE calls OWNER TO fluxuser;

--
-- Name: channels; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE channels OWNER TO fluxuser;

--
-- Name: complete; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE complete OWNER TO fluxuser;

--
-- Name: db_data; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE db_data OWNER TO fluxuser;
...
ALTER TABLE fifo_outbound OWNER TO fluxuser;
...
ALTER TABLE fifo_bridge OWNER TO fluxuser;

--
-- Name: group_data; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE fifo_callers OWNER TO fluxuser;
...
ALTER TABLE group_data OWNER TO fluxuser;

--
-- Name: interfaces; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE interfaces OWNER TO fluxuser;

--
-- Name: limit_data; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE limit_data OWNER TO fluxuser;

--
-- Name: members; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE members OWNER TO fluxuser;

--
-- Name: nat; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
CREATE TABLE nat (
    sticky integer,
    port integer,
...
ALTER TABLE nat OWNER TO fluxuser;

--
-- Name: recovery; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE recovery OWNER TO fluxuser;

--
-- Name: registrations; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE registrations OWNER TO fluxuser;

--
-- Name: sip_registrations; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE sip_registrations OWNER TO fluxuser;

--
-- Name: sip_authentication; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE sip_authentication OWNER TO fluxuser;

--
-- Name: sip_dialogs; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE sip_dialogs OWNER TO fluxuser;

--
-- Name: sip_presence; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE sip_presence OWNER TO fluxuser;

--
-- Name: sip_shared_appearance_dialogs; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE sip_shared_appearance_dialogs OWNER TO fluxuser;

--
-- Name: sip_shared_appearance_subscriptions; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE sip_shared_appearance_subscriptions OWNER TO fluxuser;

--
-- Name: sip_subscriptions; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
...
ALTER TABLE sip_subscriptions OWNER TO fluxuser;

--
-- Name: tasks; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
CREATE TABLE tasks (
    task_id integer,
...
ALTER TABLE tasks OWNER TO fluxuser;

--
-- Name: tiers; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
CREATE TABLE tiers (
   queue character varying(255),
...
ALTER TABLE tiers OWNER TO fluxuser;


--
-- Name: json_store; Type: TABLE; Schema: public; Owner: fluxuser; Tablespace:
--
CREATE TABLE json_store (
 ...
 ALTER TABLE json_store OWNER TO fluxuser;
  
--Create Views

-- Name: basic_calls; Type: VIEW; Schema: public; Owner: fluxuser
...
ALTER TABLE basic_calls OWNER TO fluxuser;

-- Name: detailed_calls; Type: VIEW; Schema: public; Owner: fluxuser
...
ALTER TABLE detailed_calls OWNER TO fluxuser;
